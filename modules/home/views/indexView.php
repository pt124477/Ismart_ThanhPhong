    ...
    <div class="wp-inner">
        <div class="main-content fl-right">
            ...
            <div class="section" id="list-product-wp">
                ...
                <?php foreach ($category_name as $item1) { ?>
                    <div class="section-head">
                        <?php if($item1['parent_id'] == 0){ ?>
                        <h3 class="section-title"><?php echo $item1['category_name'] ?></h3>
                        <?php }?>
                        <div class="section-detail">
                            <ul class="list-item clearfix">
                                <?php if (!empty($show_product)) { ?>
                                    <?php foreach ($show_product as $item2) {
                                        $imageId = $item2['image_id'];
                                        $imageUrl = isset($imageMap[$imageId]) ? $imageMap[$imageId] : 'chưa có';
                                    ?>
                                        <?php if($item1['category_id'] == $item2['category_id']){ ?>
                                        <li>
